...
GameBoardWindow::GameBoardWindow(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::GameBoardWindow),gameBoard()
{
    ui->setupUi(this);
    mouseflag=true;
    chessSkin=0;
...
void GameBoardWindow::paintEvent(QPaintEvent *)
{
...
void GameBoardWindow::mouseReleaseEvent(QMouseEvent* event)
{
    //鼠标释放事件
    int x,y;
    if(mouseflag)
...
void GameBoardWindow::mouseMoveEvent(QMouseEvent *event)
{
...
void GameBoardWindow::on_pushButton_clicked()
{
...
void GameBoardWindow::on_pushButton_2_clicked()
{
...
void GameBoardWindow::on_changeChessSkin_clicked()
{
...
void GameBoardWindow::on_pushButton_3_clicked()
{
    this->close();
...
void GameBoardWindow::on_pushButton_4_clicked()
{
...
void GameBoardWindow::on_pushButton_5_clicked()
{
    int a[15][15];
    gameBoard.copyChess(a);
    gameBoard.clearChess();
    qDebug()<<"gameBoard.length=============================="<<gameBoard.length;
    for(int i = 0;i < gameBoard.length;++i){
        QPoint temp = gameBoard.getPoint(i);
        gameBoard.chess[temp.x()][temp.y()] = a[temp.x()][temp.y()];
        qDebug()<<temp.x()<<":x++++++++++++++++y:"<<temp.y();
